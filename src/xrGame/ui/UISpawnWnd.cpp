...
CUISpawnWnd::CUISpawnWnd() : m_iCurTeam(0)
{
    ...
    m_pImage3 = new CUIStatix();
    AttachChild(m_pImage3);
    m_pImage4 = new CUIStatix();
    AttachChild(m_pImage4);
    m_pImage5 = new CUIStatix();
    AttachChild(m_pImage5);
    m_pImage6 = new CUIStatix();
    AttachChild(m_pImage6);
    m_pImage7 = new CUIStatix();
    AttachChild(m_pImage7);
    m_pImage8 = new CUIStatix();
    AttachChild(m_pImage8);
    m_pImage9 = new CUIStatix();
    AttachChild(m_pImage9);
    ...
    m_pFrames[3] = new CUIStatic();
    AttachChild(m_pFrames[3]);
    m_pFrames[4] = new CUIStatic();
    AttachChild(m_pFrames[4]);
    m_pFrames[5] = new CUIStatic();
    AttachChild(m_pFrames[5]);
    m_pFrames[6] = new CUIStatic();
    AttachChild(m_pFrames[6]);
    m_pFrames[7] = new CUIStatic();
    AttachChild(m_pFrames[7]);
    m_pFrames[8] = new CUIStatic();
    AttachChild(m_pFrames[8]);
...
bool CUISpawnWnd::OnKeyboardAction(int dik, EUIMessages keyboard_action)
{
    ...
    if (SDL_SCANCODE_1 == dik || SDL_SCANCODE_2 == dik || SDL_SCANCODE_3 == dik ||
        SDL_SCANCODE_4 == dik || SDL_SCANCODE_5 == dik || SDL_SCANCODE_6 == dik ||
        SDL_SCANCODE_7 == dik || SDL_SCANCODE_8 == dik || SDL_SCANCODE_9 == dik)
    {
        if (SDL_SCANCODE_1 == dik)
            game->OnTeamSelect(0);
        else if (SDL_SCANCODE_2 == dik)
            game->OnTeamSelect(1);
        else if (SDL_SCANCODE_3 == dik)
            game->OnTeamSelect(2);
        else if (SDL_SCANCODE_4 == dik)
            game->OnTeamSelect(3);
        else if (SDL_SCANCODE_5 == dik)
            game->OnTeamSelect(4);
        else if (SDL_SCANCODE_6 == dik)
            game->OnTeamSelect(5);
        else if (SDL_SCANCODE_7 == dik)
            game->OnTeamSelect(6);
        else if (SDL_SCANCODE_8 == dik)
            game->OnTeamSelect(7);
        else if (SDL_SCANCODE_9 == dik)
            game->OnTeamSelect(8);
        else
            game->OnTeamSelect(8);
